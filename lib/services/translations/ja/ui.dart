// lib/services/translations/ja/ui.dart
const Map<String, String> jaUI = {
  // --- 基本UI ---
  'settings': '設定',
  'save': '保存する',
  ...
  'policy_s1_desc':
      '本アプリで入力された名前、誕生日、好きなもの、およびAPIキー、会話履歴は、すべてお客様のブラウザのローカルストレージにのみ保存されます。開発者がこれらのデータを取得・閲覧することはありません。',
  ...
  'nest_gender_label': 'パートナーの性別',
  'relationship_label': '二人の関係性',
  'label_rel_lover': '恋人',
  'label_rel_bestFriend': '親友',
  'desc_rel_lover': '甘い時間を過ごす、かけがえのない存在。恋人としての特別な会話を楽しめます。',
  'desc_rel_bestFriend': '何でも話せる、一番の理解者。信頼し合える親友としての会話になります。',
