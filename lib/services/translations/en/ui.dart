// lib/services/translations/en/ui.dart
const Map<String, String> enUI = {
  // --- Basic UI ---
  'settings': 'Settings',
  'save': 'Save',
  'language': 'Language',
  ...
  'label_rel_lover': 'Lover',
  'label_rel_bestFriend': 'Best Friend',
  'desc_rel_lover':
      'An irreplaceable partner to spend sweet times with. Enjoy special romantic conversations.',
  'desc_rel_bestFriend':
      'The person who understands you best. Engage in conversations based on mutual trust and friendship.',
  // --- Precautions ---
