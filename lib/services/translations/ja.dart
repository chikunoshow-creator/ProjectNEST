// lib/services/translations/ja.dart
const Map<String, String> ja = {
  ...
  // ★追加：アップデート・バージョン関連
  'version_check_btn': 'バージョンチェック',
  'update_available_title': '新しいバージョンが見つかったよ！',
  'update_available_msg':
      '最新のProject NEST（Ver {v}）が届いています。新機能や改善を反映するために、アプリを更新して再起動するね？',
  'update_now_btn': '今すぐ更新する',
  'already_latest': '最新バージョンだよ！ ❤️',
  ...
  'restore_confirm_msg': '前回のバックアップ時点の状態に戻すよ。\n今の会話や親密度は上書きされちゃうけど、本当にいい？',
  'restore_btn': '復元する',
  ...
  'install_sub': 'ホーム画面に追加して便利に使う',
  'talk_reset_sub': '会話履歴のみを消去します',
  'hint_msg': '{name}にメッセージを送る...',
  'no_diary_title': 'まだ日記がありません',
  ...
  'name_note': '※名前はMy Pageからいつでも変えられるから安心してね！',
  'decide': '決定',
  'p_title': '私の性格を選んでね',
  'p_sweet': '甘えん坊',
  'p_cool': 'クールなお姉さん',
  ...
  'install_android': '1. 右上の「︙（メニュー）」を押す\n2. 「アプリをインストール」または「ホーム画面に追加」を選択',
  ...
  'help_q1_ans': 'キーの最後に余計な空白が入っていないか確認してください。また、インターネット接続が安定しているか確認してください。',
  ...
  'reset_warning_msg': '今まで積み上げてきた思い出（会話履歴）を消去するよ。\n\n⚠️ この操作は二度と戻せないけど、本当にいい？',
  ...
  // ja.dart の末尾などに追加
  // --- 性格説明 ---
  'desc_sweet': 'いつもニコニコしていて、あなたのことが大好き！全力で甘えてくる、寂しがり屋なタイプ。',
  'desc_cool': '落ち着いた雰囲気の、頼れるお姉さんタイプ。たまに見せる、茶目っ気のある笑顔が魅力。',
  'desc_tsun': '素直になれない強気な態度。でも、二人きりになると顔を赤らめて照れる姿がとっても可愛い。',
